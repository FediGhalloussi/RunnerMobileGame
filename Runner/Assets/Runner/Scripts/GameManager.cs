...
namespace HyperCasual.Runner
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        public void NoInputStart()
        {
            m_IsPlaying = false;
        }
        public void NoInputStop()
        {
            m_IsPlaying = true;
        }
        ...
        public bool CleanBoss()
        {
            BossController bossController = FindObjectOfType<BossController>();
            if (bossController != null)
            {
                float playerWaterLevel = PlayerController.Instance.GetWaterLevel();
                Debug.Log("c'est clean");
                return bossController.CleanBoss(playerWaterLevel);
            }
            Debug.Log("c'est pas clean");

            return false; // If there's no boss controller, cleaning fails
        }
