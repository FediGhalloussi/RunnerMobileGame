...
namespace HyperCasual.Runner
{
    ...
    public class Gate : Spawnable
    {
        ...
        protected override void Awake()
        {
            ...
            m_Value = Random.Range(1, 10) * 10;

            m_Text.GetComponent<TextMeshPro>().text = (m_Multiplier == 1 ? "+ " : "- ") + m_Value;
            if (m_Text != null)
            {
        ...
        void ActivateGate()
        {
            switch (m_GateType)
            {
                ...
                case GateType.ChangeWater:
                    PlayerController.Instance.AdjustWater(m_Value * m_Multiplier);
                break;
            }

            m_Applied = true;

            AudioManager.Instance.PlayEffect(SoundID.KeySound);
