...
namespace HyperCasual.Runner
{
    ...
    public class SettingsMenu : View
    {
        ...
        void MusicToggleChanged(bool value)
        {
            ...
            if (!value)
            {
                m_CrossMusic.gameObject.SetActive(true); // Show the cross image
            }
            else
            {
                m_CrossMusic.gameObject.SetActive(false); // Hide the cross image
            }
        }
        ...
        void SfxToggleChanged(bool value)
        {
            ...
            if (!value)
            {
                m_CrossSFX.gameObject.SetActive(true); // Show the cross image
            }
            else
            {
                m_CrossSFX.gameObject.SetActive(false); // Hide the cross image
            }
        }
